defmodule TrackUpstream do
  ...
  # ============================================================================
  # MAIN MODULE (Escript entry point)
  # ============================================================================

  defmodule Main do
    @moduledoc """
    Main entry point for the escript command-line tool.
    """
    ...
    defp print_usage do
      IO.puts("""
      Track Upstream - Derivative project change tracker

      Usage: track_upstream <upstream_start_rev> <upstream_end_rev> <downstream_rev> [options]
      ...
      Options:
        ...
        --skip-analyze         - Skip detailed analysis (only show matches)

      Examples:
        track_upstream v1.0.18 v1.1.14 abc123
        track_upstream v1.0.18 v1.1.14 abc123 --upstream-dir ../upstream-repo
        track_upstream v1.0.18 v1.1.14 abc123 --skip-analyze
